window.onload = function()
{
	...
	oOldPwd.onblur = function(){
	var oRegExpOldPwd = new RegExp("^[A-Za-z0-9]{6}$");
		if (oRegExpOldPwd.test(oOldPwd.value)==false) {
			oOldPwd.style.borderColor = "red";
			oMsgTextid.innerHTML = "*Senha de 6 digitos alphanumericos";
		}
		oOldPwd.onfocus = function(){
			oOldPwd.style.borderColor = "";
